      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4">
              {requirements.map((req, i) => (
                <div key={i} className="flex items-start gap-4 p-5 bg-[#1A1A1A] border border-gray-800 rounded-xl">
          ...
          <div className="bg-[#1A1A1A] border border-gray-800 rounded-2xl p-8 md:p-10">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-background rounded-xl border border-gray-800">
