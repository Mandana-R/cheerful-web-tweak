        ...
        <div className="container mx-auto px-6 max-w-[1180px]">
          <div className="border border-white/[0.12] rounded-2xl bg-card/5 backdrop-blur-lg p-8 md:p-11">
            <div className="flex flex-col md:flex-row gap-7 items-start">
              ...
              />
              <div>
                <h3 className="font-display text-2xl font-bold text-white mb-1">Kourosh Eshman</h3>
        ...
        <div className="container mx-auto px-6 max-w-[1180px]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="border border-white/[0.12] rounded-xl bg-white/[0.03] p-7 text-center">
        ...
        <div className="container mx-auto px-6 max-w-[1180px]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="border border-white/[0.12] rounded-xl bg-white/[0.03] p-5">
