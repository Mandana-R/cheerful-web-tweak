        ...
        <div className="container mx-auto px-6 max-w-[1180px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="border border-white/10 rounded-xl bg-white/[0.02] p-7 transition-all hover:border-emerald/25 hover:bg-emerald/[0.03]">
        ...
        <div className="container mx-auto px-6 max-w-[1180px]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="border border-white/10 rounded-xl bg-white/[0.02] p-8 text-center">
